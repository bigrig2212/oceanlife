...
Vehicle.prototype.applyBehaviors = function(vehicles,seekx,seeky) {
     var separateForce = this.separate(vehicles);
     var seekForce = this.seek(createVector(seekx, seeky));
...
Vehicle.prototype.borders = function() {
  // Wraparound
    ...
    if (this.position.y < (height/2)-this.r) this.position.y = this.position.y - 10; //this is a really cool effect - jumping skywards
    //if (this.position.y < (height/2)-this.r) this.position.y = (height/2)-this.r + random(1,5); //keeps the vehicles in the water
